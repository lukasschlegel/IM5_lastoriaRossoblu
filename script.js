...
ballTL
  ...
  /* ===========================
     Info-Overlay Toggle
     =========================== */
  const infoBtnHitbox = document.querySelector(".info-btn-hitbox");
  const infoText      = document.querySelector(".info-text");

  if (infoBtnHitbox && infoText) {
    // Klick auf die kleine Hitbox toggelt die Sprechblase
    infoBtnHitbox.addEventListener("click", () => {
      infoText.classList.toggle("visible");
    });

    // Beim Scrollen Info wieder ausblenden (optional)
